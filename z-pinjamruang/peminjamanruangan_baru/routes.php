...
Route::group(['middleware' => ['web']], function() {
	...
	Route::get('pinjamruang/buat', 'PeminjamanController@getPeminjamanRuangan');
	Route::post('pinjamruang/buat/getruangan', 'PeminjamanController@buatPeminjamanRuanganPost');
	Route::post('pinjamruang/buat/proses', 'PeminjamanController@buatPeminjamanRuanganPost');
	Route::get('pinjamruang/buat_formdetail', 'PeminjamanController@getFormDetailPeminjamanRuangan');
	Route::post('pinjamruang/buat_formdetail/proses', 'PeminjamanController@buatPeminjamanRuangan2Post');

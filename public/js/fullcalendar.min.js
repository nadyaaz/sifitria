        ...
        function f(d) {
            ...
            return f && a.each(f.split(" "), function(d) {
                ...
                a.each(this.split(","), function(d, e) {
                    ...
                    "title" == e ? (g = g.add(a("<h5>&nbsp;</h5>")), h = !1) : ((f = (b.options.customButtons || {})[e]) ? (j = function(a) {

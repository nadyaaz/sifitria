	...
	//<![CDATA[
			$(document).ready(function() {
				...
				$('#jadwaljson').click(function(){
						$kategori = $('input[type="radio"][name="jenisRuangan"]:checked').val();
						var tanggal = $('.datepicker').val();
						var waktumulai = $('#waktuMulai').val();
						var waktuselesai = $('#waktuSelesai').val();
						var data = { jenisRuangan: kategori, tanggal:tanggal, waktuMulai: waktuMulai, waktuSelesai: waktuSelesai};
						alert($kategori);
					$.ajax({
						url: '/json/ruangan',
						type: 'POST',	
    					processData: false,
    					dataType: 'json',
						data: { jenisRuangan: $kategori, tanggal: tanggal, waktuMulai: waktuMulai, waktuSelesai: waktuSelesai},
